...
function createCanvas(opts) {
  ...
  //文字居中
  cc.translate(0, canvas_height / 2);
...
function prepareOpts(opts) {
  ...
  fweight = opts.fweight || 'normal', //normal / bold / bolder / lighter
  fsize = parseInt(opts.fsize) || '', //auto calculate the font size to response to the image size
...
function placeholder(opts) {
  return placeholderCanvas(opts).toDataURL("image/png",1);
}
