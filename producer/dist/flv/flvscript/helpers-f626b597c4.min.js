...
window.require = function(){
    $.each(arguments, function(){
        if($.isArray(this)){
            ...
            $.each(this, function(path, files){
                $.each(files, function(){
                    writeScript(path+this);
                });
            });
    ...
    function writeScript(f) {
        document.write('<scr'+'ipt src="'+f + '?' + proversion +'"></scr'+'ipt>');
